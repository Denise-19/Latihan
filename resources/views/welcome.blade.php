    ...
    <script>
        $(function() {
            ...
            $(document).on("submit", "#frmSoal1", function(e) {
                ...
                let konsonan_valid = ['b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r',
                    's', 't', 'v', 'w', 'y', 'z'
                ];
                let isError = false;
            ...
            $(document).on("submit", "#frmSoal2", function(e) {
                ...
                if (value_1 == null || value_1 == undefined || value_1 == "" || value_2 == null ||
                    value_2 == undefined || value_2 == "") {
                    $(".soal-2-alert").html("");
                    swal_error(
                        "ERROR #Question 2 . Number of families or number of members in family is required"
                        );
                    isError = true;
                    return false;
                }
                ...
                split_value_2.forEach((element, index) => {
                    if (isNaN(element) == false) {
                        if (element == 0) {
                            $(".soal-2-alert").html("");
                            swal_error(
                                "ERROR #Question 2 . Input first char / after space cannot 0");
                            isError = true;
                            return false;
                        }
